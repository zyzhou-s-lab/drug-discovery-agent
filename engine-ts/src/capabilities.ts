    ...
    toolGroups: [
      {
        ...
        tools: [
          ...
          mk("ontology_lookup", "在本体库查疾病 / 表型 / 基因术语(MONDO / EFO / HP / GO,经 EBI OLS4)", [str("query")]),
          mk("get_opentarget_targets", "从 Open Targets 取排序后的「靶点–疾病」关联(keyless GraphQL)", [str("disease")]),
